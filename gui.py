...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_feedback.setGeometry(QtCore.QRect(0, 150, 251, 61))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(70, 50, 112, 21))
        self.layoutWidget.setObjectName("layoutWidget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.layoutWidget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.label_id = QtWidgets.QLabel(parent=self.layoutWidget)
        self.label_id.setObjectName("label_id")
        self.horizontalLayout.addWidget(self.label_id)
        self.input_id = QtWidgets.QLineEdit(parent=self.layoutWidget)
